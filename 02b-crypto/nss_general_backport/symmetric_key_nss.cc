...
// static
std::unique_ptr<SymmetricKey> SymmetricKey::GenerateRandomKey(Algorithm algorithm,
  ...
  std::unique_ptr<SymmetricKey> key(new SymmetricKey(sym_key));

  return key;
}

// static
std::unique_ptr<SymmetricKey> SymmetricKey::DeriveKeyFromPassword(Algorithm algorithm,
